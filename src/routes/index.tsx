  ...
  head: () => ({
    meta: [
      { title: "VoltDot — Pakistan's Certified GaN Charger Brand" },
      {
        name: "description",
        content:
          "Shop GaN chargers, braided cables, power banks and car accessories. Certified, warrantied and built for daily use.",
      },
      { property: "og:title", content: "VoltDot — Pakistan's Certified GaN Charger Brand" },
      {
        property: "og:description",
        content: "Certified chargers and accessories engineered for everyday performance.",
      },
    ],
  }),
  component: Index,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="mb-12 flex flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-xl text-muted-foreground">
              Compact GaN bricks for every device — from earbuds to MacBooks.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="mb-10 flex items-end justify-between">
            ...
            <Link to="/collections" className="hidden md:inline text-mint hover:underline underline-offset-4">
              View all →
            </Link>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {collections.map((c) => (
              <Link
                ...
                to="/collections/$slug"
                params={{ slug: c.slug }}
                className="group flex flex-col rounded-xl border border-border bg-card p-8 transition hover:border-mint/40 hover:shadow-[var(--shadow-card)]"
              >
                <span className="text-xs uppercase tracking-widest text-muted-foreground">{c.count} products</span>
                <span className="mt-2 font-display text-2xl tracking-wide group-hover:text-mint transition">
                  {c.name}
                </span>
